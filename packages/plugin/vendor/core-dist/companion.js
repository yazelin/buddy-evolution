 ...
 */
import { SPECIES, EYES, HATS, STAT_NAMES, RARITY_WEIGHTS, COMPANION_SALT, } from './types.js';
...
function rollStats(rand, statFloor) {
...
// --- Public API ---
export function rollCompanionBones(userId) {
    ...
    const bones = { rarity, species, eye, hat, shiny, stats, inspirationSeed };
    rollCache.set(userId, bones);
    return bones;
}
export function clearRollCache() {
    rollCache.clear();
}
