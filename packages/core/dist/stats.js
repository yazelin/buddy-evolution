 ...
 */
export function calculateRawStatGrowth(stat, session) {
    switch (stat) {
        case 'DEBUGGING':
 ...
 */
export function applyDiminishingReturns(rawGrowth, currentGrowth) {
    if (rawGrowth <= 0)
        return 0;
 ...
 */
export function calculateStatGrowth(stat, session, currentGrowth) {
 ...
 */
export function getEffectiveStat(baseStat, growthBonus) {
